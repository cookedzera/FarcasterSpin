...
contract WheelGame is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant AIDOGE = 0x09e18590e8f76b6cf471b3cd75fe1a1a9d2b2c2b;
    address public constant BOOP = 0x13A7DeDb7169a17bE92B0E3C7C2315B46f4772B3;
    address public constant BOBOTRUM = 0x60460971a3D79ef265dfafA393ffBCe97d91E8B8;
    ...
    function claimAllRewards() external nonReentrant {
        ...
        if (aidogeAmount > 0) {
            ...
            IERC20(AIDOGE).transfer(msg.sender, aidogeAmount);
        ...
        if (boopAmount > 0) {
            ...
            IERC20(BOOP).transfer(msg.sender, boopAmount);
        ...
        if (bobotrumAmount > 0) {
            ...
            IERC20(BOBOTRUM).transfer(msg.sender, bobotrumAmount);
